...
public class NicePermissionUtils {
    ...
    private String[] getNoPermission(String[] params) {
        ...
        LogUtils.Companion.getInstance().d(sb.toString(), "tag");
    ...
    public void requestPermissions(Context context) {
        LogUtils.Companion.getInstance().e("requestPermissions", "manyfunction");
    ...
    private NiceDialog showPermissionDialog(final Context context, String[] permissions) {
        LogUtils.Companion.getInstance().e("showPermissionDialog", "manyfunction");
        ...
        return NiceShowView.Companion.getInstance().createDialog(context, NiceDialog.Companion.getDIALOG_NORMAL())
                .setTitle("关于权限")
    ...
    public void handleRequestPermissionsResult(Context context, int requestCode, String[] permissions, int[] grantResult) {
        ...
        switch (requestCode) {
            case REQUEST_CODE_ASK_PERMISSIONS:
                ...
                //是否请求到全部权限的
                if (result) {
                    LogUtils.Companion.getInstance().d("success", "tag");
                } else {
                    LogUtils.Companion.getInstance().d("failed", "tag");
                }
                break;
            default:
                break;
        ...
        LogUtils.Companion.getInstance().d(sb.toString(), "manyfunction");
    }
