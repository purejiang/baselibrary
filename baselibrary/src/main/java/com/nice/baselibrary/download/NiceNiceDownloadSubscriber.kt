 ...
 * @date 2019/3/6.
 */
class NiceNiceDownloadSubscriber(private val niceDownloadInfo: NiceDownloadInfo, private val niceDownloadListener: NiceDownloadListener,private val niceDownloadDataSource: NiceDownloadDataSource) : DisposableObserver<ResponseBody>(), NiceDownloadProgressListener {
